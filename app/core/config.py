...
class Settings(BaseSettings):
    ...
    # At K=60 we still occasionally missed one of 6 plan rows ("compare all
    # plans for Asia 15d 35yo" returned 5/6). K=100 closes that gap. ~5K
    # tokens of context per query — still negligible for Sonnet.
    rag_top_k: int = 100
